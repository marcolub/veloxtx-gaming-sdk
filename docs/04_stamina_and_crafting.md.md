...
2. Stamina Consumption (CONSUME_STAMINA)A native rate-limiting mechanic designed to slow down repetitive actions and catch automation software or third-party macros (Bots).
Zod Schema & Control Metadata JavaScriptpayload: 
```
{ 
  activityId: z.string(), 
